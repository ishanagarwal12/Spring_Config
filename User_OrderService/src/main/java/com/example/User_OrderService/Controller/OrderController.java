...
import com.example.User_OrderService.Entity.ItemRepository;
import com.example.User_OrderService.Entity.ListItems;
import com.example.User_OrderService.Entity.OrderEntity;
import com.example.User_OrderService.Entity.OrderRepository;
...
public class OrderController {
    ...
    public Object getByOrder(@PathVariable int orderId) {
        List<OrderEntity> list = findByOrderId(orderId);
        if (list != null)
            return list;
        else
